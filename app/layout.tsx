...
export const metadata: Metadata = {
  ...
  description:
    "JOS Travel accompagne particuliers et entreprises dans la création de voyages sur mesure, billets, visas, hôtels, excursions et séjours au Cameroun comme à l'international.",
  keywords: [
    "JOS Travel",
