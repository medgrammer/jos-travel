...
export function AuthWidget() {
  ...
  return (
    <>
      ...
      {open ? (
        <div className="fixed inset-0 z-[80] flex items-center justify-center bg-ocean-950/35 px-4 backdrop-blur-sm">
          <div className="relative max-h-[92svh] w-full max-w-2xl overflow-y-auto rounded-[8px] border border-cyan-100 bg-white p-5 shadow-lift md:p-6">
            <button
              type="button"
              onClick={() => setOpen(false)}
              aria-label="Fermer"
              className="absolute right-4 top-4 inline-flex h-10 w-10 items-center justify-center rounded-full bg-cyan-50 text-ocean-950"
            >
